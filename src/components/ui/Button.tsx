...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  ghost: 'bg-transparent text-[var(--foreground)] hover:bg-[var(--background-tertiary)] border border-[var(--border)]',
};
    ...
    return (
      <button
        ...
        className={`
          ...
          transition-all duration-160 ease-[cubic-bezier(0.4,0,0.2,1)]
